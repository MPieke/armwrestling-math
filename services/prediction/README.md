...
# --model-family: elo, glicko2, bradley_terry (feature-schema outcomes_elo_v1, "rating")
#                 logreg, tabpfn (feature-schema history_v1, "tabular"; tabpfn needs `uv sync --extra tabpfn`)
