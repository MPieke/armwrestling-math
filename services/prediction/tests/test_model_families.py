...
def test_model_families_registry_has_all_three_tier_a_families():
    assert set(MODEL_FAMILIES) == {"elo", "glicko2", "bradley_terry"}
...
@pytest.mark.parametrize(
    ...
    [("elo", {"k_factor"}), ("glicko2", set()), ("bradley_terry", {"l2_regularization"})],
)
...
@pytest.mark.parametrize("family_name", ["elo", "glicko2", "bradley_terry"])
